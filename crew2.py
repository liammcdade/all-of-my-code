...
class KeyEvent:
    def __init__(self, name, time_val=0):
        self.name = name
        self.time = time_val
...
class AutoKeyboardPresser:
    def __init__(self, root):
        ...
        # Pre-load keys: 1, 2, 3, 4, 5, a, b, m
        self.recorded_keys = [KeyEvent('1', i*0.1) for i in range(13)]
        self.recorded_keys[1] = KeyEvent('2', 0.1)
        self.recorded_keys[2] = KeyEvent('3', 0.2)
        self.recorded_keys[3] = KeyEvent('4', 0.3)
        self.recorded_keys[4] = KeyEvent('5', 0.4)
        self.recorded_keys[5] = KeyEvent('a', 0.5)
        self.recorded_keys[6] = KeyEvent('b', 0.6)
        self.recorded_keys[7] = KeyEvent('m', 0.7)
        self.recorded_keys[8] = KeyEvent('6', 0.8)
        self.recorded_keys[9] = KeyEvent('7', 0.9)
        self.recorded_keys[10] = KeyEvent('8', 1.0)
        self.recorded_keys[11] = KeyEvent('9', 1.1)
        self.recorded_keys[12] = KeyEvent('0', 1.2)
    ...
    def bind_hotkeys(self):
        ...
        keyboard.add_hotkey(self.hotkey_play, self.toggle_play_pause)
    ...
    def toggle_play_pause(self):
        if self.playing and not self.paused:
            ...
            self.paused = True
            self.status_label.config(text="Status: Paused", foreground="#e67e22")
